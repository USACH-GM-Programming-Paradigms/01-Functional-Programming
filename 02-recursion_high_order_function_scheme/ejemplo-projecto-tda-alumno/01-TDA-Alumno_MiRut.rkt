...
(provide make-alumno)
(provide get-nombre-alumno get-notas-alumno)
(provide set-nombre-alumno set-notas-alumno)
...
;; Dom: Alumno
;; Rec: Nombre (str)
;; Ejemplo: (get-nombre-alumno miAlumno)
;; Output: "gonzalo"
(define (get-nombre-alumno alumno) (car alumno))

;; Descripción: Obtiene notas del alumno
;; Dom: Alumno
;; Rec: Notas
;; Ejemplo: (get-notas-alumno miAlumno)
;; Output: (1 2 3)
(define (get-notas-alumno alumno) (cadr alumno))
...
;; Rec: Alumno
;; Ejemplo: (set-nombre-alumno mi-alumno "gonzalo martinez")
...
;; Dom: Alumno X Nombre (str)
;; Rec: Alumno
;; Ejemplo: (set-nota-alumno mi-alumno (4 5 6))
